...
class SAR_Indexer:
    """
    Prototipo de la clase para realizar la indexacion y la recuperacion de artÃ­culos de Wikipedia
        
        Preparada para todas las ampliaciones:
          posicionales + busqueda semÃ¡ntica + ranking semÃ¡ntico
    ...
    def __init__(self):
        ...
        self.semantic_ranking = None # Â¿Â¿ ranking de consultas binarias ??
        self.model = None
        self.MAX_EMBEDDINGS = 200 # nÃºmero mÃ¡ximo de embedding que se extraen del kdtree en una consulta
    ...
    def set_semantic_threshold(self, v:float):
        ...
        Cambia el umbral para la bÃºsqueda semÃ¡ntica.

        input: "v" booleano.

        UTIL PARA LA AMPLIACIÃ“N

        si self.semantic es False el umbral no tendrÃ¡ efecto.
    ...
    def set_semantic_ranking(self, v:bool):
        ...
        si self.semantic_ranking es True se harÃ¡ una consulta binaria y los resultados se rankearÃ¡n por similitud semÃ¡ntica.
    ...
    def load_semantic_model(self, modelname:str=SEMANTIC_MODEL):
        ...
        Carga el modelo de embeddings para la bÃºsqueda semÃ¡ntica.
    ...
    def update_embeddings(self, txt:str, artid:int):
        ...
        AÃ±ade los vectores (embeddings) de los chuncks del texto (txt) correspondiente al articulo artid a los indices.
        Pasos:
    ...
    def create_kdtree(self):
        ...
        Crea el tktree utilizando la informaciÃ³n de los embeddings
    ...
    def semantic_reranking(self, query:str, articles: List[int]):
        ...
        Pasos:
            ...
            2 - calcular la similitud coseno de la consulta con todos los embeddings de cada artÃ­culo
            3 - ordenar los artÃ­culos en funciÃ³n de la mejor similitud.
    ...
    def get_posting(self, term:str):
        ...
        Puede llamar self.get_positionals: para las bÃºsquedas posicionales.
    ...
    def get_positionals(self, terms:str):
        ...
        NECESARIO PARA LAS BÃšSQUESAS POSICIONALES
